...
$("#switch-train-destination").click((e) => {
    ...
    const destinationPlaceholder = $(`[name=train-destination-placeholder]`).val()
...
const incrementAmadeus = (e) => {
    ...
    if(target == 'adult-amadeus')
    {
        if(value > 1)
        {
            $('.decrement-amadeus[target=adult-amadeus]').prop('disabled', false)
            $('.increment-amadeus[target=infant-amadeus]').prop('disabled', false)
        }
    }
    ...
    console.log(adultval)
    $(`#input-passenger-amadeus`).val(`${adultval + childval + infantval} Passenger`)
}
...
const incrementDomestic = (e) => {
    ...
    if(target == 'adult-amadeus')
    {
        if(value > 1)
        {
            $('.decrement-domestic[target=adult-domestic]').prop('disabled', false)
            $('.increment-domestic[target=infant-domestic]').prop('disabled', false)
        }
    }
    ...
    console.log(adultval)
    $(`#input-passenger-domestic`).val(`${adultval + childval + infantval} Passenger`)
}
...
const incrementTrain = (e) => {
    ...
    console.log(adultval)
    $(`#input-passenger-train`).val(`${adultval + childval + infantval} Passenger`)
}
...
const incrementBus = (e) => {
    ...
    console.log(adultval)
    $(`#input-passenger-bus`).val(`${adultval + childval + infantval} Passenger`)
}
...
const showSelectorAmadeus = () => {
    $("#passenger-selector-amadeus #selector-amadeus").css('visibility', 'visible');
}

/* show selector domestic */
const showSelectorDomestic = () => {
    $("#passenger-selector-domestic #selector-domestic").css('visibility', 'visible');
}
...
const hideSelectorAmadeus = (e) => {
    e.preventDefault()
    $("#passenger-selector-amadeus #selector-amadeus").css('visibility', 'hidden');
}

/* hide selector domestic */
const hideSelectorDomestic = (e) => {
    e.preventDefault()
    $("#passenger-selector-domestic #selector-domestic").css('visibility', 'hidden');
}
...
$("[name=train-destination-placeholder]").keyup((e) => searchStation(e, 'destination'));
