                    ...
                    <div class="card-body">
                        <div class="row justify-content-start align-items-center">
                            ...
                            <div class="col-6 col-lg-2  ms-2">
                                <div class="d-flex flex-column">
                                    <span class="text-black fw-bold">${
                                        value.trainName
                                    } (${value.trainNumber})</span>
                                    <span class="small">${
                                        classes.find(
                                            (el) =>
                                                el.subClass === data.subClass
                                        ).className +
                                        "(" +
                                        data.subClass +
                                        ")"
                            ...
                            <div class="col-12 col-lg-7 ms-2">
                                <div class="row row-cols-3 row-cols-lg-auto align-items-center  justify-content-lg-between">
                                    ...
                                    <div class="col-12 col-lg-auto col-md-auto arrival ms-lg-3 d-flex flex-column">
                                        ...
                                        <p class="m-0 text-center"><small>${
                                            value.arrivalTime.split("T")[0] +
                                            " " +
                                            value.arrivalTime.split("T")[1]
                                        }</small></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-12 text-start text-lg-end">
                                <h5 class="fw-bold text-info m-0 mb-2">${new Intl.NumberFormat(
                                    "id-ID",
                                    {
                                        style: "currency",
                                        currency: "IDR",
...
const trainSchedule = async () => {
    ...
    if (
        response.respMessage === "rute tidak tersedia" &&
