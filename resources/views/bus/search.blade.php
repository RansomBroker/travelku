...
@section('content')
    ...
    <div class="m-0">
        ...
        <input type="hidden" name="bus-origin" value="{{ $_GET['bus-origin'] }}">
        <input type="hidden" name="bus-destination" value="{{ $_GET['bus-destination'] }}">
        <input type="hidden" name="passenger" value="{{ $_GET['adult-bus'] }}">
                    ...
                    <div class="row justify-content-between align-items-center d-n">
                        <div class="row col-12 col-lg-6 flex-column">
                            <div class="col-6 col-lg-6 d-flex justify-content-start">
                                <span class="text-black">{{ $_GET['bus-origin'] }}</span>
                                <span class="text-black"><i class='bx bx-right-arrow-alt'></i></span>
                                <span class="text-black">{{ $_GET['bus-destination'] }}</span>
                            </div>
...
@section('custom-js')
    ...
    <script src="{{ asset('assets/js/bus-search.js') }}"></script>
