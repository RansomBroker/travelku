...
@section('title', 'Travelku - Admin Login')
    ...
    <div class="authentication-inner">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <p class="mb-4">Admin area - Login to manage your site</p>

          <form id="formAuthentication" class="mb-3" action="{{ URL::to('api/admin/auth/login') }}" method="POST">
            <div class="mb-3">
