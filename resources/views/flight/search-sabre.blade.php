                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <div class="detail">
                                    ...
                                    <p class="m-0">{{ $_GET['departure'] }} |
                                        ...
                                        {{ $_GET['adult'] + $_GET['children'] + $_GET['infant'] }} Passenger |
...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        const adult = "{{ $_GET['adult'] }}"
        const children = "{{ $_GET['children'] }}"
        const infant = "{{ $_GET['infant'] }}"
        const returns = "{{ $_GET['return'] ?? null }}"
        const api = "{{ URL::to('api/flight/sabre/search') }}"
        const base = "{{ URL::to('/') }}"
    ...
    <script src="{{ asset('assets/js/flight.sabre.js') }}" type="text/javascript"></script>
